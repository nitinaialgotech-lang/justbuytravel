  ...
  return (
    <>
      ...
      <div className="container my-5">
        ...
        <div className="mb-4">
          <p><strong>Last updated:</strong> August 31, 2023</p>
        ...
        <section className="mb-4">
          ...
          <ul>
            ...
            <li><strong>Website</strong> refers to this website, accessible from <a href="https://justbuytravel.com">https://justbuytravel.com</a></li>
        ...
        <section className="mb-4">
          ...
          <ul>
            <li><strong>By email:</strong> <a href="mailto:info@justbuytravel.com">info@justbuytravel.com</a></li>
            <li><strong>By visiting this page on our website:</strong> <a href="/contact">Contact</a></li>
          </ul>
        </section>
      </div>
      <Footer />
