  ...
  return (
    <>
      ...
      <div className="container termscondition_section">
        ...
        <div className="section_title privacy_title">
          <h2 className="g_color">Terms and Conditions</h2>
          <h6><strong>Last updated:</strong> August 31, 2023</h6>
        ...
        <section className="section_title privacy_content">
          ...
          <ul>
            ...
            <li><strong >Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to My Business, My Address.</li>
            <li><strong >Country</strong> refers to: United States</li>
            <li><strong >Service</strong> refers to the Website.</li>
            <li><strong >Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement is maintained by the Terms and Conditions Generator.</li>
            <li><strong >Third-party Social Media Service</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</li>
            <li><strong >Website</strong> refers to this website, accessible from <Link className='g_color' href="https://justbuytravel.com">https://justbuytravel.com</Link></li>
        ...
        <section className="privacy_content">
          ...
          <ul>
            <li><strong>By email:</strong> <Link className='g_color' href="mailto:info@justbuytravel.com">info@justbuytravel.com</Link></li>
            <li><strong>By visiting this page on our website:</strong> <Link className='g_color' href="/contact">Contact</Link></li>
          </ul>
        </section>
      </div>
      <Footer />
