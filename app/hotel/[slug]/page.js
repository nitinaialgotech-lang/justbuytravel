...
import { generateHotelMetadata, generateBlogMetadata, generateHotelStructuredData, generateBlogStructuredData, generateBreadcrumbStructuredData, getHotelIdFromSlug } from '@/app/utils/seo';
...
export async function generateMetadata({ params, searchParams }) {
    try {
        ...
        if (blog) return generateBlogMetadata(blog);
