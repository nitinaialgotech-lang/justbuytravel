...
export const metadata = {
  ...
  icons: {
    icon: `${basePath}/logo/cropped-Frame.png`,
    shortcut: `${basePath}/logo/cropped-Frame.png`,
    apple: `${basePath}/logo/cropped-Frame.png`,
  },
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${siteUrl}${basePath}/logo/cropped-Frame.png`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Just Buy Travel: Trusted Reviews, Travel Deals & Destination Ideas",
    description: "Travel made easy with Just Buy Travel. Explore honest reviews, best hotel offers, tours, attractions & dining deals—all in one place.",
    images: [`${siteUrl}${basePath}/logo/cropped-Frame.png`],
...
export default function RootLayout({ children }) {
  ...
  const organizationSchema = {
    ...
    "url": siteUrl,
    "logo": `${siteUrl}${basePath}/logo/cropped-Frame.png`,
    "description": "Travel made easy with Just Buy Travel. Explore honest reviews, best hotel offers, tours, attractions & dining deals—all in one place.",
    "sameAs": [
