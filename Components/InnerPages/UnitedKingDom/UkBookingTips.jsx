...
export default function UkBookingTips() {
    ...
    const card = [
        {
            img: "/justbuytravel_next/demo/innerpages/UK/uk4.webp"
        },
        {
            img: "/justbuytravel_next/demo/innerpages/UK/uk1.webp"
        },
        {
            img: "/justbuytravel_next/demo/innerpages/UK/uk2.webp"
        },
        {
            img: "/justbuytravel_next/demo/innerpages/UK/uk3.webp"
        },
    ]
    return (
        <>
                                ...
                                <div className="row ">
                                    <div className="col-lg-6">
                                        <div className="hotel_tips_img">
                                            <img src="/justbuytravel_next/demo/innerpages/UK/uk4.webp" alt="" />
                                        </div>

                                    </div>
                                    <div className="col-lg-6">
                                        <div className="hotel_tips_img">
                                            <img src="/justbuytravel_next/demo/innerpages/UK/uk1.webp" alt="" />
                                        </div>
                                    </div>
                                    <div className="col-lg-6  mt-4">
                                        <div className="hotel_tips_img">
                                            <img src="/justbuytravel_next/demo/innerpages/UK/uk2.webp" alt="" />
                                        </div>
                                    </div>
                                    <div className="col-lg-6 mt-4 ">
                                        <div className="hotel_tips_img">
                                            <img src="/justbuytravel_next/demo/innerpages/UK/uk3.webp" alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
