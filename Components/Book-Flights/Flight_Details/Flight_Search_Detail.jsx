...
export default function Flight_Search_Detail() {
  ...
  const travel_class = useSelector(
    (state) => state.user.SearchFlight.travelClass,
  );
  ...
  console.log(flight, "........flightNitin", data);
                            ...
                            <div className="d-block d-lg-none">
                              <div className="departure_item flex justify-end items-center gap-2  p-0 text-right  ">
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    const token =
                                      item?.booking_token || item?.departure_token;
                                    if (!token) return;
                                    route.push(
                                      `/booking-options?_tok=${encodeURIComponent(
                                        token,
                                      )}`,
                                    );
                                  }}
                            ...
                            <div className="departure_title flex items-center gap-3 md:gap-4">
                              <div className="logo flex flex-col items-center gap-1">
                                ...
                                <span className="text-[11px] text-gray-500 uppercase tracking-wide">
                                  {item?.flights?.map((item) => item?.airline)}
                                </span>
                              </div>
