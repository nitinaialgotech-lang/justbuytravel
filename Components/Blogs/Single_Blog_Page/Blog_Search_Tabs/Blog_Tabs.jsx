                            ...
                            <div className="blog_card_box mb-10">
                              <div className="blog_card">
                                <div className="blog_card_img">
                                  <img
                                    src={post?.yoast_head_json?.og_image?.[0]?.url || "/default-image.webp"}
                                    alt=""
                                  />
                                </div>
                                <div className="blog_card_body">
                                  <h4 dangerouslySetInnerHTML={{ __html: post.title.rendered }} />
                                  <div dangerouslySetInnerHTML={{ __html: truncateWords(post.excerpt.rendered) }} />
                                </div>
                              </div>
                            </div>
                          </div>
                                        ...
                                        <div className="blog_card">
                                          ...
                                          <div className="blog_card_body">
                                            <div className="card_body_blog_time flex justify-between items-center">
                                              ...
                                              <p className="m-0 g_color">October 13, 2025</p>
                                            </div>
                                            {/* ****************************** */}
