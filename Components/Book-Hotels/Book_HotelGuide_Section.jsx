        ...
        <div className="row justify-center">
          <div className="col-lg-12">
            ...
            <div className="section_title trust_guide_content">
              <h2>Our Trusted Hotel Booking and Travel companies</h2>
              <p className="g_color fw-semibold">
                As your travel guide, we help you avoid scams and travel with confidence.
              </p>
              <p>
                Over the years, we have worked with trusted travel brands that help book hotels, flights, holiday packages, and cruises. Travelers can compare prices, locations, and guest reviews all in one place before confirming their stay. This makes it easy to browse and choose accommodations based on your travel plans, budget, and destination preferences around the world.
              </p>
              {/* <p>
