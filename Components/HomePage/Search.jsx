                            ...
                            <div className="search_tab">
                                <div className="tab_link flex justify-between items-center">
                                    <ul className="flex items-center p-0">
                                        <li>
                                            <Link href={""} className={`${activeTab === "all" ? "g_color" : ""}`} onClick={(e) => {
                                                e.preventDefault(); setSearchAll(true); setActiveTab("all"); setContenttext("place to go,things to do,hotels...");
                                        ...
                                        <li>
                                            <Link href={""} className={`${activeTab === "flights" ? "g_color" : ""}`} onClick={(e) => { e.preventDefault(); setActiveTab("flights"); setContenttext("Flight, Travel .."); localStorage.setItem("searchType", "flight") }}>
